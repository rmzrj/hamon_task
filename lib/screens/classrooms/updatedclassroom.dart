...
class UpdatedClassroom extends StatefulWidget {
  var val;
  Classrooms classroom;
  UpdatedClassroom({Key key, this.classroom, this.val}) : super(key: key);

  @override
  _UpdatedClassroomState createState() => _UpdatedClassroomState();
}

class _UpdatedClassroomState extends State<UpdatedClassroom> {
